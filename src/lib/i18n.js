...
const STRINGS = {
  vi: {
    ...
    viewMap: '🗺 Bản đồ',
    mapMain: 'Kho chính',
    mapMainTitle: 'Kiến thức thiết kế — trừ những nhánh đã có bản đồ riêng',
    mapPick: 'Chọn bản đồ',
    ...
    ttsRead: 'Đọc thành tiếng (voice tiếng Anh)',
    ttsPause: 'Tạm dừng',
    ttsResume: 'Đọc tiếp',
    ttsStop: 'Dừng hẳn',
    ttsPrev: 'Đoạn trước',
    ttsNext: 'Đoạn sau',
    ttsRate: 'Tốc độ đọc',
    ttsVoice: 'Giọng đọc — chỉ liệt kê voice tiếng Anh có sẵn trên máy',
    ttsAuto: 'liên tục',
    ttsAutoTitle: 'Đọc xong node này thì tự sang node kế tiếp trong lộ trình có bản tiếng Anh',
    ttsNoEn: 'Mục này chưa có bản tiếng Anh nên chưa đọc được — voice chỉ có tiếng Anh.',
    ttsSwitch: 'Đọc thành tiếng — sẽ bật chế độ song ngữ để thấy đoạn đang đọc',
    ttsNoVoice: 'Máy chưa cài voice tiếng Anh',
    ttsUnsupported: 'Trình duyệt này không đọc thành tiếng được',
  },
  en: {
    ...
    viewMap: '🗺 Map',
    mapMain: 'Core vault',
    mapMainTitle: 'Design knowledge — minus the branches that have their own map',
    mapPick: 'Pick a map',
    ...
    ttsRead: 'Read aloud (English voice)',
    ttsPause: 'Pause',
    ttsResume: 'Resume',
    ttsStop: 'Stop',
    ttsPrev: 'Previous chunk',
    ttsNext: 'Next chunk',
    ttsRate: 'Speed',
    ttsVoice: 'Voice — only English voices installed on this machine',
    ttsAuto: 'continuous',
    ttsAutoTitle: 'When this node ends, move on to the next translated node in the reading path',
    ttsNoEn: 'No English version of this section yet — nothing to read. The voice is English only.',
    ttsSwitch: 'Read aloud — switches to bilingual so you can see what is being read',
    ttsNoVoice: 'No English voice installed',
    ttsUnsupported: 'This browser cannot speak text',
  },
}

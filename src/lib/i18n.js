...
const STRINGS = {
  vi: {
    ...
    ttsRead: 'Đọc thành tiếng',
    ttsReadVi: 'Đọc thành tiếng — giọng tiếng Việt',
    ttsReadEn: 'Đọc thành tiếng — giọng tiếng Anh',
    ttsLang: 'Ngôn ngữ đọc',
    ttsPause: 'Tạm dừng',
    ttsResume: 'Đọc tiếp',
    ttsStop: 'Dừng hẳn',
    ttsPrev: 'Đoạn trước',
    ttsNext: 'Đoạn sau',
    ttsRate: 'Tốc độ đọc',
    ttsVoice: 'Giọng đọc — liệt kê voice của ngôn ngữ đang đọc, có sẵn trên máy này',
    ttsAuto: 'liên tục',
    ttsAutoTitle: 'Đọc xong node này thì tự sang node kế tiếp trong lộ trình đọc',
    ttsNoVoiceVi: 'Máy chưa cài giọng đọc tiếng Việt — thêm trong phần Giọng nói của hệ điều hành',
    ttsNoVoiceEn: 'Máy chưa cài giọng đọc tiếng Anh',
    bootFail: 'Không nạp được dữ liệu',
    bootRun: 'Chạy',
    bootThen: 'để sinh public/data/graph.json, rồi',
    closeMenu: 'Đóng menu',
    viewMapTitle: 'Bản đồ kiến thức',
    viewPracticeTitle: 'Hỏi — tự trả lời thành tiếng — tự chấm',
    expandAllTitle: 'Mở hết các nhánh',
    collapseAllTitle: 'Thu gọn hết các nhánh',
    allRelationsTitle: 'Hiện TẤT CẢ liên kết ngang. Mặc định chỉ hiện liên kết của node đang chọn.',
    modeMindmapHint: 'Toả hai bên quanh gốc',
    modeTreeHint: 'Trái sang phải',
    modeRadialHint: 'Vòng tròn quanh gốc',
    readOrder: 'Thứ tự trong lộ trình đọc',
    expandChildren: 'Mở {n} node con',
    collapseChildren: 'Thu gọn {n} node con',
    stubTitle: 'Stub — chưa viết sâu',
    masteryTitle: 'Đã thuộc {p}% số câu phỏng vấn của node này',
    noPromptStart: 'Chưa có. Thêm mục',
    noPromptEnd: 'vào cuối',
  ...
  en: {
    ...
    ttsRead: 'Read aloud',
    ttsReadVi: 'Read aloud — Vietnamese voice',
    ttsReadEn: 'Read aloud — English voice',
    ttsLang: 'Reading language',
    ttsPause: 'Pause',
    ttsResume: 'Resume',
    ttsStop: 'Stop',
    ...
    ttsNext: 'Next chunk',
    ttsRate: 'Speed',
    ttsVoice: 'Voice — lists voices for the reading language installed on this machine',
    ttsAuto: 'continuous',
    ttsAutoTitle: 'When this node ends, move on to the next node in the reading path',
    ttsNoVoiceVi: 'No Vietnamese voice installed — add one in your OS speech settings',
    ttsNoVoiceEn: 'No English voice installed',
    bootFail: 'Could not load the data',
    bootRun: 'Run',
    bootThen: 'to generate public/data/graph.json, then',
    closeMenu: 'Close menu',
    viewMapTitle: 'Knowledge map',
    viewPracticeTitle: 'Ask — answer out loud — grade yourself',
    expandAllTitle: 'Expand every branch',
    collapseAllTitle: 'Collapse every branch',
    allRelationsTitle: 'Show ALL cross-links. By default only the selected node’s links are drawn.',
    modeMindmapHint: 'Spreads both ways around the root',
    modeTreeHint: 'Left to right',
    modeRadialHint: 'A circle around the root',
    readOrder: 'Position in the reading path',
    expandChildren: 'Expand {n} child nodes',
    collapseChildren: 'Collapse {n} child nodes',
    stubTitle: 'Stub — not written in depth yet',
    masteryTitle: 'You know {p}% of this node’s interview questions',
    noPromptStart: 'Not written yet. Add a',
    noPromptEnd: 'section at the end of',

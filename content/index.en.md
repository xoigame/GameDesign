...
1. **Knowledge layer** (branches 1–6, 8–11) — principles of game design and game AI. This is shared vocabulary: the AI reads it so you both mean the same thing by the same words.
...
| [[cocos-creator]] | Cocos Creator 3.x: picking an engine by where you ship, a Unity → Cocos map, web and mini-game traps | Building an H5 game or a mini game inside a super app |
| [[backend-go]] | Go backend and databases: API, realtime rooms, Postgres/Redis, economy data | The game has accounts, IAP or a leaderboard |
